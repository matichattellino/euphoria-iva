...
export default function GaugeChart({ debito, credito }) {
  ...
  const debitoPercent = total > 0 ? (debito / total) * 100 : 50;
  const creditoPercent = total > 0 ? (Math.abs(credito) / total) * 100 : 50;
  ...
  return (
    <div className="bg-dark-800 border border-dark-600 rounded-2xl p-6">
      <h3 className="text-sm font-medium text-slate-400 mb-4">Proporción Débito / Crédito</h3>
